/**
 * @file offsets.h
 * @brief WoW WotLK 3.3.5a memory offsets and descriptors (imported from IceFlake)
 *
 * All values are absolute virtual addresses within the WoW process or relative
 * byte offsets.
 */
...
// ===========================================================================
// Nested types imported from IceFlake's Pointers.cs
// ===========================================================================
...
namespace Object {
    constexpr uint32_t GetObjectName = 54; // vtable index
    constexpr uint32_t GetObjectLocation = 12; // vtable index
    constexpr uint32_t GetObjectFacing = 14; // vtable index
    constexpr uint32_t Interact = 44; // vtable index
...
namespace LocalPlayer {
    ...
    constexpr uint32_t ComboPointsTarget = 0x00BD08A8; // ulong, guid
...
// ===========================================================================
// Flat aliases for existing codebase compatibility
// ===========================================================================
...
constexpr uint32_t spellCastSpell                  = 0x0080DA40;
...
constexpr uint32_t unitCastingIdOffset     = 0xC08;
constexpr uint32_t unitChannelIdOffset     = 0xC20;
...
constexpr uint32_t cameraOffset2           = 0xE8;
...
// ===========================================================================
// Descriptors imported from IceFlake's Descriptors.cs
// ===========================================================================
...
inline constexpr uint32_t DescriptorToByteOffset(uint32_t descIndex) {
    return descIndex * 4;
}
